...
trait OpaqueOperatorTests extends FunSuite with BeforeAndAfterAll { self =>
  ...
  ignoreTestAgainstSpark("TPC-DS 26") { securityLevel =>
    TPCDS.tpcds(26, spark.sqlContext, securityLevel, numPartitions)
  }

  ignoreTestAgainstSpark("TPC-DS 28") { securityLevel =>
    TPCDS.tpcds(28, spark.sqlContext, securityLevel, numPartitions)
  }

  ignoreTestAgainstSpark("TPC-DS 81") { securityLevel =>
    TPCDS.tpcds(81, spark.sqlContext, securityLevel, numPartitions)
  }

  ignoreTestAgainstSpark("TPC-DS 88") { securityLevel =>
    TPCDS.tpcds(88, spark.sqlContext, securityLevel, numPartitions)
  }

  testAgainstSpark("TPC-DS 96") { securityLevel =>
    TPCDS.tpcds(96, spark.sqlContext, securityLevel, numPartitions)
  }
